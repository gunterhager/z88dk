...
include(`target/mz800/config/config_target.m4')
include(`target/mz800/config/config_cpu.m4')
include(`target/mz800/config/config_clib.m4')
include(`target/mz800/config/config_clib_const.m4')
